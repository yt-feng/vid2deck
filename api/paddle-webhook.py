...
try:
    from _external_grant import grant_external_benefit, resolve_external_benefit
    ...
    from api._external_grant import grant_external_benefit, resolve_external_benefit
...
def process_author_tip(
    ...
    grant_metadata = (
        {external_config.metadata_key: grant_result}
        if linked_benefit
        else {}
    )
    gift_metadata = (
        {
            "gift_benefit_site": external_config.gift_benefit_site,
            **grant_metadata,
        }
        if linked_benefit
        else {}
