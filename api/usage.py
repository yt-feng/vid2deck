...
class handler(BaseHTTPRequestHandler):
    ...
    def handle_sponsor_order(self, data: dict[str, Any]) -> None:
        ...
        payload = {
            ...
            "site_origin": "vid2ppt",
            "benefit_site": "kcdesk" if plan_code in KCDESK_GIFT_PLAN_CODES else "vid2ppt",
            "benefit_plan": (
                "kcdesk_trial_3d"
                if plan_code == "NOVA-3D"
                else "kcdesk_member" if plan_code in KCDESK_GIFT_PLAN_CODES else "redeem_code"
            ),
            "metadata": {
                "site_origin": "vid2ppt",
                "source_site": "vid2ppt",
